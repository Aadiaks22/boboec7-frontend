  ...
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[230px_1fr]">
      ...
      <div className="flex flex-col">
        <div className="">
          <header className="fixed left-0 right-0 sm:w-full lg:left-[230px] lg:w-[calc(100%-230px)] z-10 flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6 print:hidden">
            <Sheet>
        ...
        <div>
          <main className="flex flex-1 flex-col mt-10 gap-4 p-4 lg:gap-6 lg:p-6">
            <Outlet />
          </main>
        </div>
      </div>
